!function (a, b) {
    function c(a) {
        return function () {
            var b = {method: a}, c = Array.prototype.slice.call(arguments);
    ...
    d.DEBUG = !1, d.VERSION = "0.0.11", d.CONTEXT = "player.js", d.POST_MESSAGE = !!a.postMessage, d.origin = function (b) {
        ...
        var f = this;
        d.isString(c) && (c = b.getElementById(c)), this.elem = c, d.assert("IFRAME" === c.nodeName, 'playerjs.Player constructor requires an Iframe, got "' + c.nodeName + '"'), d.assert(c.src, "playerjs.Player constructor requires a Iframe with a 'src' attribute."), this.origin = d.origin(c.src), this.keeper = new d.Keeper, this.isReady = !1, this.queue = [], this.events = d.EVENTS.all(), this.methods = d.METHODS.all(), d.POST_MESSAGE ? d.addEvent(a, "message", function (a) {
            f.receive(a)
        ...
        if (d.log("Player.off", c), c.length > 0) for (var e in c) return this.send({
        ...
        for (var c = "event" === a ? this.events : this.methods, e = 0; e < b.length; e++) if (-1 === d.indexOf(c, b[e])) return !1;
        return !0
    };
    ...
    d.addEvent(a, "message", function (a) {
        ...
        var c = {};
        if (d.isObject(b.data)) c = b.data; else try {
        ...
        if ("addEventListener" === c.method) this.eventListeners.hasOwnProperty(c.value) ? -1 === d.indexOf(this.eventListeners[c.value], f) && this.eventListeners[c.value].push(f) : this.eventListeners[c.value] = [f], "ready" === c.value && this.isReady && this.ready(); else if ("removeEventListener" === c.method) {
        ...
        var b = this.receiver = new d.Receiver;
        this.looped = !1, a.on("pause", function () {
            b.emit("pause")
        }), a.on("play", function () {
            b.emit("play")
        }), a.on("time", function (a) {
            var c = a.position, d = a.duration;
            if (!c || !d) return !1;
        ...
        var a = {
            duration: 20, currentTime: 0, interval: null, timeupdate: function () {
            }, volume: 100, mute: !1, playing: !1, loop: !1, play: function () {
                a.interval = setInterval(function () {
                    a.currentTime += .25, a.timeupdate({seconds: a.currentTime, duration: a.duration})
                }, 250), a.playing = !0
            }, pause: function () {
        ...
        a.on("pause", function () {
            ...
            var d = a.currentTime(), e = a.duration();
            if (!d || !e) return !1;
